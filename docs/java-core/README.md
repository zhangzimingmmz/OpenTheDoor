...
8. 学习 [Java并发编程](./07-Java并发编程.md)，掌握线程、同步、线程池、并发集合
9. 学习 [Java新版本特性](./05-Java新版本特性.md)
10. 实践：手写HashMap、实现LRU缓存、使用线程池优化并发性能、使用新特性改进代码
...
| **ConcurrentHashMap** | [06](./06-Java集合框架.md), [07](./07-Java并发编程.md) |
| **ArrayList** | [06](./06-Java集合框架.md) |
| **线程** | [07](./07-Java并发编程.md) |
| **synchronized** | [07](./07-Java并发编程.md) |
| **volatile** | [07](./07-Java并发编程.md) |
| **线程池** | [07](./07-Java并发编程.md) |
...
### 高频题（⭐⭐⭐⭐）
1. **HashMap和ConcurrentHashMap的区别** [06](./06-Java集合框架.md), [07](./07-Java并发编程.md)
2. **HashMap的扩容机制** [06](./06-Java集合框架.md)
3. **synchronized和volatile的区别** [07](./07-Java并发编程.md)
4. **线程池的核心参数和执行流程** [07](./07-Java并发编程.md)
5. **ConcurrentHashMap的实现原理** [07](./07-Java并发编程.md)
...
- **2025-01** - 新增并发编程章节（完整版）
  - 新增 [07-Java并发编程](./07-Java并发编程.md) 主文档
  - **核心章节（4个）：**
    - [07-01-线程基础](./07-01-线程基础.md) - Thread、Runnable、Callable、线程生命周期
    - [07-02-线程同步与内存模型](./07-02-线程同步与内存模型.md) - synchronized、volatile、JMM、happens-before
